...
- Interacción: scroll o dos dedos = pan; pellizco o Cmd/Ctrl+rueda = zoom; clic = seleccionar; Shift+clic = ruta BFS entre dos nodos; clic derecho = abrir la tabla en el catálogo; Esc = cerrar. Hover sobre el núcleo de una tabla rota su esfera para revelar las columnas traseras; al acercarse a una columna la rotación se congela para poder seleccionarla.
